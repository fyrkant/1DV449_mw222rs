...
/***/ function(module, exports, __webpack_require__) {
	...
	setTimeout(function () {
		return _store2.default.dispatch(_actions2.default.startListeningToSocket());
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (currentState, action) {
		switch (action.type) {
			case _constants2.default.RECEIVING_DATA:
				return Object.assign({}, currentState, {
					data: action.data
				});
			default:
				return currentState || _initialState2.default.data;
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		startListeningToSocket: function startListeningToSocket() {
			return function (dispatch, getState) {
				ws.onmessage = function (event) {
					dispatch({
						type: _constants2.default.RECEIVING_DATA,
						data: event.data
					});
				};
			};
